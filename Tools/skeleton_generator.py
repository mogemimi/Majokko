...
//  http://enginetrouble.net/pomdog/LICENSE.md for details.
//
""").substitute(year="2014", copyright_holder=copyright_holder)
...
def CreateClassHeader(identifier_without_directory):
    ...
    return CreateHeader(GetGitUserName()) +\
           ...
           CreateIncludeGuardSection(
               ...
               CreateNamespace("Majokko", CreateNamespace("Details")) + return_code) +\
           return_code
...
def CreateImplement(identifier_without_directory):
    ...
    return CreateHeader(GetGitUserName()) +\
		   ...
		   return_code +\
           CreateNamespace("Majokko", CreateNamespace("Details")) +\
           return_code
